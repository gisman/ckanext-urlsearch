...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.urlsearch.some_setting = some_default_value
...
## Releasing a new version of ckanext-urlsearch

If ckanext-urlsearch should be available on PyPI you can follow these steps to publish a new version:
